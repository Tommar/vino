...
$B(document).ready(function() {				
	...
	if(bsData.navType=='nav-thumb'){
		...
		var img = new Image();
		var pathway = bsData.url + '/modules/mod_bt_apb/tmpl/images/';
...
function replayVideo(activeContainer) {
 ...
 if(typeof (player[activeContainer])!= "undefined"){
	console.log(typeof(player[activeContainer].playVideo));
...
function preloadImage(photos) {
	//var img = new Image();
	//img.src = bsData.url + '/modules/mod_bt_apb/tmpl/images/loading.gif';
}
