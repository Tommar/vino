...
//set style for module
    ...
    ?>    
            ...
            ?>
                ...
                ?>
                    ...
                    foreach ($formFields as $field) {
                        ...
                        ?>
                        <div class="btqc-field-container btqc-field-<?php echo $field->type ?>">
						
						<div class="btqc-field-container-inner1">
						<div class="btqc-field-container-inner2">
                        <?php
                ...
                case 'dropdown':
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                            ...
                                            <select name="btqc<?php echo $module->id ?>[btqc_f_<?php echo $field->alias ?>]" id="btqc_f_<?php echo $field->alias ?>" size="<?php echo $field->size ?>" class="<?php echo ($field->required) ? 'required' : '' ?>">
                                    <?php
                                ...
                                case 'date':
									...
									<div class="field-calendar">
										<input 
											...
											id="btqc_f_<?php echo $field->alias ?>"
											/>
										<i id="btqc_f_<?php echo $field->alias ?>-img" class="fa fa-calendar btqc-calendar-img"></i>
                ...
                case 'pagebreak':
                                    ...
                                    <?php if($count > 1 ){
                                    ?>
                                    <button class="button btqc_prev" type="button" /><?php echo JText::_('PREV_STEP') ?></button>
                                    <?php    
                                    }?>
                                    <button class="button btqc_next" type="button" /><?php echo JText::_('NEXT_STEP') ?></button>
                                    <?php
                                    break;
                                default: break;
                            }
                        ...
                        if ($count >= count($forms)) {
                            ...
                            if ($params->get('send_copy')) {
                                ?>
                            <div class="btqc-field-container btqc-field-sendcopy">
            ...
            if ($params->get('captcha') || ($params->get('captcha') === null && JFactory::getConfig ()->get ( 'captcha' ))) {
                ?>
                        ...
                        <div class="btqc-field-container btqc-field-submit">
                            ...
                            <button class="button btqc_prev" type="button" /><?php echo JText::_('PREV_STEP') ?></button>
                            <?php }?>
                            <button class="btqc_submit button" type="submit" name="btqc<?php echo $module->id ?>[btqc_f_submit]" />
								<?php echo JText::_('BT_BISTRO_BT_QUICKCONTACT_BOOKING_TABLE') ?>
							</button>
                        </div>    
            <?php
        }
        ?>    	
			...
			<input id="bttoken<?php echo $module->id?>" type="hidden" value="1" name="<?php echo JSession::getFormToken(true)?>">		
			<div style="clear:both;"></div>
        </form>
    </div>
    <script type="text/javascript">
                        ...
                        if(BTQC(this).valid()){
                            BTQC(this).ajaxSubmit({
                                ...
                                success: function(response, statusText, xhr, wrapper){
									...
									BTQC('#bttoken<?php echo $module->id?>').attr('name', response.bttoken);
