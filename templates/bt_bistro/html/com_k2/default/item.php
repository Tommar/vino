			...
			<div class="commentUserImage">
				...
				<div class="commentHead">
					...
					<div class="commentDate">
							<?php echo JText::_('K2_COMMENT_POST')?> <?php echo JHTML::_('date', $comment->commentDate, JText::_('d.m.Y')).' in '.JHTML::_('date', $comment->commentDate, JText::_('H:i')); ?>
						</div>
