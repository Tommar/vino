...
<div class="itemViewInner">
	...
	<?php if(($this->item->params->get('catItemDateCreated')) || ($this->item->params->get('catItemAuthor')) || ($this->item->params->get('catItemCommentsAnchor')) || $this->item->params->get('catItemTitle')): ?>  
	...
	<?php if(($this->item->params->get('catItemDateCreated')) || ($this->item->params->get('catItemAuthor')) || ($this->item->params->get('catItemCommentsAnchor'))): ?>  
	
	<div class="itemViewInfo">
	  <?php if($this->item->params->get('catItemDateCreated')): ?>
		<!-- Date created -->
		<div class="catItemDateCreated">
			<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_LISTING')); ?>
		</div>
		<?php endif; ?>
