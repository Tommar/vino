    ...
    BT.Slideshow=new Class({
        ...
        add:function(d, tmp){
            ...
            var b = new Element("li",{
                html:(d.youid ? videoicon :'')+ '<img src="'+this.options.liveUrl+"modules/mod_bt_apb/images" + (tmp ? "/tmp" : "" ) +"/manager/"+d.file+'" /><a href="javascript:void(0)" class="edit">Edit</a><a href="javascript:void(0)" class="remove">Remove</a>'
            });
			if(d.remote){
