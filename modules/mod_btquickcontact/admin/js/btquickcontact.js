    ...
    BT.PreviewForm = new Class({
            ...
            */
            ...
            switch (type){
                ...
                case 'dropdown':
					...
					field.label = jQ('#btqc-field-dropdown-label').val();
                    break;
                case 'richedit':
            ...
            switch(field.type){
                ...
                case 'dropdown':
					...
					if(typeof(field.label) != 'undefined' && field.label != ''){
						liHTML += '<option value="">' + field.label + '</option>';
					}
        ...
        edit:function(li){
            ...
            if(field != null){
				...
				if(field.type == 'dropdown'){
					jQ('#btqc-field-dropdown-label').val(field.label);
				}
                if(field.type == 'file'){
        ...
        update: function(li, field){
            ...
            //initial HTML field (input tag or other)
            ...
            switch (type){
                ...
                case 'dropdown':
                    ...
                    field.options = jQ('#btqc-field-options').val().split('|');
                    htmlField.html('');
					htmlField.append(jQ('<option>').attr('value', '').html(field.label));
                    for(var i = 0; i< field.options.length; i++){
