...
class JFormFieldBtFields extends JFormField {
    ...
    protected function getAddFieldForm(){
        $html = '<ul id="btqc-add-field-form" class="btqc-dialog-container ' . (version_compare(JVERSION, '3.0', 'ge') ? 'isJ30' : 'isJ25') . '" >'
                ...
                . '     </li>'
				. ' 	<li class="btqc-optional dropdown">'
				. ' 		<label for="btqc-field-dropdown-label" class="hasTip" title=" ' . JText::_('FIELD_DROPDOWN_LABEL_DESC') . '">' . JText::_('DROPDOWN_LABEL') . '</label>'
				. ' 		<input type="text" name="btqc-field-dropdown-label" id="btqc-field-dropdown-label"/>'
				. '		</li>'	
